# JSON Schema Component Output Specification

## Purpose

Define deterministic standalone Draft 07 artifacts for named AsyncAPI component schemas, including their index, filenames, references, validation, diagnostics, and conformance contract.
